...
Common-law jurisdictions already recognize electronic records as legally equivalent to paper. The U.S. ESIGN Act, Canada's evidence acts, the EU's eIDAS regulation, and Australia's Electronic Transactions Act all accommodate electronic records.[^1] Nothing in these frameworks mandates a particular file format such as PDF; they are generally technology-neutral and would equally accommodate JSON records that meet the applicable integrity and accessibility requirements.

Delaware's Section 224, for example, explicitly authorizes corporations to maintain their records "on, or by means of, or be in the form of, any information storage device, method, or one or more electronic networks or databases," treating paper as derivative output.[^2]
...
[^1]: See 15 U.S.C. § 7001 et seq. (ESIGN Act), https://www.law.cornell.edu/uscode/text/15/7001; Canada Evidence Act, R.S.C. 1985, c. C-5, ss. 31.1-31.8, https://laws-lois.justice.gc.ca/eng/acts/C-5/section-31.1.html; Regulation (EU) No 910/2014 (eIDAS), https://eur-lex.europa.eu/eli/reg/2014/910/oj/eng; Electronic Transactions Act 1999 (Cth), https://www.legislation.gov.au/C2004A00553/latest
[^2]: Del. Code Ann. tit. 8, § 224. https://delcode.delaware.gov/title8/c001/sc07/index.html
